 ...
 */
package ec.com.legalpro.alfresco.bridge.service.base;
...
import ec.com.legalpro.alfresco.bridge.bean.UrlBean;
import ec.com.legalpro.alfresco.bridge.model.NetworkEntry;
import ec.com.legalpro.alfresco.bridge.model.NetworkList;
...
import ec.com.legalpro.alfresco.bridge.util.JSONUtil;
...
public class CMISBase implements Serializable {
	 ...
	 * Serial version
	 */
	private static final long serialVersionUID = 1292022890152525804L;
...
//                System.out.println("Your home network appears to be: " + homeNetwork);
     ...
     * @return
     */
    public static Session getSessionAtom() {
    ...
    public static Session getSession() {
        ...
        String loc = AlfrescoProperties.getString("alfresco.cmis.browser.url");
        ...
        parameter.put(SessionParameter.BROWSER_URL, loc);
...
//               logger.info("Listado de carpetas: "+folder.getId());
   ...
   //System.out.println("Folder a analizar " + folder.getName());
    ...
    public static Folder getRootFolder(Session session) {
        Folder folder = (Folder) session.getRootFolder();
